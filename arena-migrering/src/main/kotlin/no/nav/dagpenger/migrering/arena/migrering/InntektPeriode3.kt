...
class InntektPeriode3 : OpplysningProdusent<Int> {
    companion object {
    ...
    val opplysningsNavn: String = "Utbetalt inntekt periode 3"

    override suspend fun produser(kontekst: MigreringsKontekst): Opplysning<Int> {
        val vedtakfakta = kontekst.sakTilMigrering.vedtakfakta.filter { vedtakfakta -> vedtakfakta.kode == "INTTREDS" }
        ...
        throw IllegalArgumentException("Klarte ikke å finne Utbetalt inntekt periode 3")
    }
